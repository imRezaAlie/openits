...
<div id="button-container" class="text-center mt-3">
    ...
    <button id="save-button" class="custom-button" onclick="showNameModal()">Save Diagram db</button>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="nameModalLabel">Save BPMN Diagram</h5>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="diagramName">Diagram Name</label>
                    <input type="text" class="form-control" id="diagramName" placeholder="Enter diagram name">
                </div>
            </div>
