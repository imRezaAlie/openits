...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="{{route('supplier.index')}}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a href="{{route('project.index')}}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a href="{{route('apis.index')}}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 6H20V8H4V6ZM4 11H20V13H4V11ZM4 16H14V18H4V16Z" fill="#90959F"/>
                        </svg>
                    </div>
                    <span class="nav-text">API Docs</span>
                </a>
            </li>
            <li><a href="{{route('integrations.tree')}}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2L2 7V17L12 22L22 17V7L12 2ZM12 4.18L19.3 8L12 11.82L4.7 8L12 4.18ZM4 9.47L11 13.13V19.28L4 15.62V9.47ZM13 19.28V13.13L20 9.47V15.62L13 19.28Z" fill="#90959F"/>
                        </svg>
                    </div>
            ...
            <li><a href="{{ route('integrations.catalog') }}" aria-expanded="false">
                    ...
                    <span class="nav-text">Integration Catalog</span>
                </a>
            </li>
            <li><a href="{{ route('data-stack.index') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 4H10V10H4V4ZM14 4H20V10H14V4ZM4 14H10V20H4V14ZM14 14H20V20H14V14Z" fill="#90959F" opacity="0.5"/>
                            <path d="M6 6H8V8H6V6ZM16 6H18V8H16V6ZM6 16H8V18H6V16ZM16 16H18V18H16V16Z" fill="#90959F"/>
                        </svg>
                    </div>
                    <span class="nav-text">Data Stack</span>
                </a>
            </li>
            <li><a href="{{ route('domains.index') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2L4 5V11.09C4 16.14 7.41 20.85 12 22C16.59 20.85 20 16.14 20 11.09V5L12 2ZM12 4.18L18 7.3V11.09C18 15.09 15.45 18.79 12 19.84C8.55 18.79 6 15.09 6 11.09V7.3L12 4.18Z" fill="#90959F"/>
                            <path d="M12 7L8 9V11.5C8 13.71 9.79 15.5 12 15.5C14.21 15.5 16 13.71 16 11.5V9L12 7Z" fill="#90959F" opacity="0.5"/>
                        </svg>
                    </div>
                    <span class="nav-text">Domains</span>
                </a>
            </li>
            <li><a href="{{route('systems.index')}}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z" fill="#90959F"/>
                            <path d="M12 6V12L16 14" stroke="#90959F" stroke-width="2"/>
                        </svg>
                    </div>
                    <span class="nav-text">Systems</span>
                </a>
            </li>
            <li><a href="{{ route('infrastructure.index') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 4H20V8H4V4ZM4 10H20V14H4V10ZM4 16H10V20H4V16Z" fill="#90959F" opacity="0.5"/>
                            <path d="M12 16H20V20H12V16ZM4 4H8V20H4V4ZM12 10H20V14H12V10Z" fill="#90959F"/>
                        </svg>
                    </div>
                    <span class="nav-text">Infrastructure</span>
                </a>
            </li>
            <li><a href="{{ route('documents.index') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 3H18C19.1 3 20 3.9 20 5V19C20 20.1 19.1 21 18 21H6C4.9 21 4 20.1 4 19V5C4 3.9 4.9 3 6 3Z" fill="#90959F" opacity="0.3"/>
            ...
            <li><a href="{{ route('technologies.index') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 5H20V7H4V5ZM4 11H20V13H4V11ZM4 17H14V19H4V17Z" fill="#90959F"/>
                            <path d="M16 17H20V19H16V17Z" fill="#90959F" opacity="0.5"/>
                        </svg>
                    </div>
                    <span class="nav-text">Technologies</span>
                </a>
            </li>
            <li><a href="{{ route('processes.index') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 3H18C19.1 3 20 3.9 20 5V19C20 20.1 19.1 21 18 21H6C4.9 21 4 20.1 4 19V5C4 3.9 4.9 3 6 3Z" fill="#90959F" opacity="0.3"/>
                            <path d="M8 7H16V9H8V7ZM8 11H16V13H8V11ZM8 15H13V17H8V15Z" fill="#90959F"/>
            ...
            <li><a href="{{ route('user.index') }}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.5" d="M9.34933 14.8577C5.38553 14.8577 2 15.47 2 17.9174C2 20.3666 5.364 21 9.34933 21C13.3131 21 16.6987 20.3877 16.6987 17.9404C16.6987 15.4911 13.3347 14.8577 9.34933 14.8577Z" fill="#90959F"/>
...
{{--            </li>--}}
            ...
            <li>
                <a href="{{ route('logout') }}"
                   ...
                   aria-expanded="false">
                    <div class="menu-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#90959F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        @endauth
        <div class="copyright">
            <p>OpenITS © <span class="current-year">2024</span> All Rights Reserved</p>
            <p>Made with <span class="heart"></span> by the OpenITS community</p>
        </div>
    </div>
</div>
